...
<div class="page-content read container-fluid">
    ...
    @if($dataTypeContent->etat == "reçue")
    <!-- Button trigger modal -->
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#valider">
        Programmer un entretien
    </button>
    @include('vendor.voyager.Candidatures.validercandidature')
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#refuser">
        Refuser
    </button>
    @include('vendor.voyager.Candidatures.refusercandidature')

    @elseif($dataTypeContent->etat == "valider")
    <button type="button" class="btn btn-success" data-toggle="modal" data-target="#accepter">
        Accepter
    </button>
    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#refuser">
        Refuser
    </button>
    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#attente">
        Liste d'attente
    </button>
    @include('vendor.voyager.Candidatures.acceptercandidature')
    @include('vendor.voyager.Candidatures.refusercandidature')
    @include('vendor.voyager.Candidatures.attentecandidature')
    @endif
