<!-- Modal -->
<div class="modal fade" id="modifierMesInfoModal" tabindex="-1" aria-labelledby="modifierMesInfoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content modal-custom">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-blue" id="modifierMesInfoModalLabel"><strong>Modifier mes information personnelles                        cursus</strong></h1>
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <input type="date" class="form-control form-control-custom" id="dateNaiss" name="dateNaiss"
                                value="" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control form-control-custom" id="lieuNaiss"
                                name="lieuNaiss" value="" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="adresse" class="col-sm-5 col-form-label">Adresse :</label>
                        <div class="col-sm-7">
                            <input type="text" class="form-control form-control-custom" id="adresse" name="adresse"
                                value="" required>
                        </div>
                    </div>
                    <div class="row mb-3">
