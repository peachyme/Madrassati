<!-- Modal -->
<div class="modal fade" id="modifierMonCursusModal" tabindex="-1" aria-labelledby="modifierMonCursusModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content modal-custom">
            <div class="modal-header">
                <h1 class="modal-title fs-5 text-blue" id="modifierMonCursusModalLabel"><strong>Modifier mon
                        cursus</strong></h1>
